...
from src.model_estimations.metropolis_conjugate_variance import (
    MCMC_LM_beta_nonconj_sigma_conj,
)


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run MH for beta (non-conjugate) with conjugate sigma2.")
...
def main() -> None:
    ...
    beta_post, sigma_post, acc_rate, info = MCMC_LM_beta_nonconj_sigma_conj(
        X_design,
        y,
        a0=args.a0,
        b0=b0,
